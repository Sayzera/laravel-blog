              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  @endif
                    ...
                    <form action="{{route('blog-ekle')}}"  method="POST"   enctype="multipart/form-data" id="hakkimizda-genel-update" data-parsley-validate="" class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="konu_basligi" name="konu_basligi"  class="form-control   @error('konu_basligi') is-invalid @enderror">
                                @error('konu_basligi')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="konu" name="konu"   class="form-control  @error('konu') is-invalid @enderror ">
                                @error('konu')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="etiketler" name="etiketler"   class="form-control  @error('etiketler') is-invalid @enderror ">
                                @error('etiketler')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
